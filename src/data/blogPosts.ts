...
export const blogPosts: BlogPost[] = [];
  ...
  // {
  //   id: '1',
  //   title: 'Mastering AI SEO: Strategies for 2024',
  //   slug: 'mastering-ai-seo-strategies-2024',
  //   excerpt: 'Discover the latest AI SEO strategies to boost your search rankings in 2024.',
