        ...
        <div className="relative">
          ...
          <div className="space-y-12">
            {steps.map((step, index) => (
              ...
              >
                <div
                  className={`absolute left-1/2 transform -translate-x-1/2 w-6 h-6 rounded-full z-10 hidden lg:block transition-all duration-500 ${
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                  <div className={index % 2 === 0 ? "lg:order-1" : "lg:order-2"}>
                    <div
                      className={`bg-white rounded-xl p-4 lg:p-6 shadow-lg hover:shadow-xl transition-all duration-500 transform ${
                        visibleSteps.includes(index)
                    ...
                    >
                      <div className="flex items-center mb-4">
                        <div
                          className={`w-10 h-10 lg:w-12 lg:h-12 rounded-lg flex items-center justify-center mr-3 lg:mr-4 transition-all duration-300 ${
                            visibleSteps.includes(index)
                        ...
                        <div>
                          <span className="text-red-500 font-medium text-xs lg:text-sm">
                            {step.week}
                          </span>
