    ...
    <section id="results" className="py-20 bg-gradient-to-br from-indigo-50 to-purple-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {results.map((result) => (
            <div key={result.metric} className="bg-white rounded-xl p-6 text-center shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {differentiators.map((item) => (
            <div key={item.title} className="bg-white rounded-xl p-6 hover:shadow-lg transition-shadow duration-200">
        ...
        <div className="bg-white rounded-2xl p-8 shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {["150%", "60 Days", "98%"].map((metric, index) => (
              <div key={metric} className="text-center">
                <div className="text-4xl font-bold text-orange-500 mb-2">{metric}</div>
