...
export default function Hero() {
  return (
    <section
      id="home"
      className="relative overflow-hidden bg-gradient-to-br from-slate-900 via-red-900 to-slate-900 py-16 lg:py-20"
    >
            ...
            <div className="space-y-4 lg:space-y-6">
              <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-primary-500/20 to-secondary-500/20 rounded-full px-4 py-2 mb-4 border border-primary-500/30">
                ...
                <span className="text-primary-300 font-medium text-sm lg:text-base">
                  AI SEO & Platform Optimization
                </span>
              </div>
              <h1 className="text-3xl md:text-4xl lg:text-6xl font-bold text-white leading-tight">
                <span className="text-primary-500">AI SEO</span>{" "}
                <span className="text-secondary-500">Optimization</span>
              </h1>
                ...
                <div className="space-y-2">
                  <div className="flex items-center text-xs sm:text-sm">
                    ...
                    <span className="text-white">
                      <strong className="text-primary-500">NordicTrack</strong> - Premium treadmills and ellipticals
                    </span>
                  </div>
                  <div className="flex items-center text-xs sm:text-sm">
                    <div className="w-2 h-2 bg-primary-500 rounded-full mr-3"></div>
                    <span className="text-white">
                      <strong className="text-primary-500">Bowflex</strong> - Innovative home gym solutions
                    </span>
                  </div>
                  <div className="flex items-center text-xs sm:text-sm">
                    <div className="w-2 h-2 bg-primary-500 rounded-full mr-3"></div>
                    <span className="text-white">
                      <strong className="text-primary-500">Peloton</strong> - Connected fitness experiences
                    </span>
                  </div>
                </div>
              </div>
