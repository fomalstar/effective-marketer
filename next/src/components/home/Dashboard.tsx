import { TrendingUp, FileText, Brain, Zap, Target } from "lucide-react";
...
const features = [
  {
    ...
    description:
      "Monitor your brand's appearance in AI autocomplete suggestions across all major platforms",
  ...
  },
  {
    ...
    description:
      "Real-time insights into competitor strategies and market trends",
  ...
  },
  {
    ...
    description:
      "Comprehensive tracking of keywords, geographic performance, and backlink profiles",
  ...
  },
  {
    ...
    description:
      "Detailed monthly performance reports and automated SEO audits",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            {features.map((feature) => (
              <div key={feature.title} className="group">
                <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-xl p-6 hover:border-primary-500/30 transition-all duration-300 hover:shadow-lg hover:shadow-primary-500/10">
          ...
          <div className="relative">
            <div className="bg-slate-800/90 backdrop-blur-sm rounded-xl shadow-2xl p-6 max-w-lg mx-auto border border-primary-500/30">
              ...
              <div className="space-y-4">
                <div className="bg-slate-700/50 border border-primary-500/30 rounded-lg p-4">
                  <div className="flex items-center justify-between mb-3">
                    <h4 className="text-primary-300 font-medium">Autosuggests Tracking</h4>
                ...
                <div className="bg-slate-700/50 border border-secondary-500/30 rounded-lg p-4">
                  <div className="flex items-center justify-between mb-3">
                    <h4 className="text-secondary-300 font-medium">Market Intelligence</h4>
        ...
        <div className="text-center mt-16">
          <a
            ...
            className="inline-block bg-gradient-to-r from-primary-500 to-secondary-500 text-white px-8 py-4 rounded-xl font-semibold text-lg hover:from-primary-600 hover:to-secondary-600 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl"
          >
